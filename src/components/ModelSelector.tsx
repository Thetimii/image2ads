...
export default function ModelSelector({ selectedModel, onSelectModel, selectedResolution, onSelectResolution, disabled, isPro = false, onShowUpgrade }: ModelSelectorProps) {
        ...
        <div className="mt-3 p-3 sm:p-4 bg-gray-50 border-2 border-gray-200 rounded-lg">
          ...
          `}
            ...
            <button
              ...
              disabled={disabled}
              onClick={() => {
                if (!isPro && onShowUpgrade) {
                  onShowUpgrade()
                  return
                }
                onSelectModel('nano-banana-pro')
              }}
              className={`
            relative p-3 sm:p-4 rounded-lg border-2 transition-all text-left
            ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer hover:border-purple-300'}
              ...
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    {!isPro && (
                      <div className="text-xs text-purple-600 font-bold mt-0.5">🔒 Pro Only</div>
                    )}
            ...
            <div className="mt-4 p-4 bg-purple-50 border border-purple-200 rounded-lg">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                <button
                  ...
                  className={`p-3 rounded-lg border-2 transition-all text-center ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer hover:border-purple-300'
